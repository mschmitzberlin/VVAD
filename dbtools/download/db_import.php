...
//    $xml_files[] = array ('file' => 'APPVALUES.XML', 'table' => 'APPVALUES');
  ...
  //  $other_files = array ('file' => 'PDF', 'path' => '../documents/')
    ...
    if (file_exists($file_with_path)) {
        ...
        while($xmlreader->read())     {
            ...
            if($xmlreader->nodeType == XMLReader::ELEMENT && $xmlreader->name == 'dataroot') {
                $xml = simplexml_import_dom($doc->importNode($xmlreader->expand(),true));
           ...
           //// echo $content . "\n";
            ...
            //        //    $content = iconv("utf-8","cp1252",$value);
            //        //    echo $content . "\n";
            //        //}
            //           
                ...
                foreach ($xml as $arr_key => $arr_value) {
                    ...
                    echo $customID . "\n";
                    $name =  strtolower ($arr_value->name);
                    $appdef_upd[] = $name;
                    $content = $arr_value->content;
                    $content = iconv("utf-8","cp1252",$content);
                //    
                    // search and convert types
                    $counter[$name]++;
    ...
    $mail_betr = "Update taegl VVAD " . date('d.m.y');
