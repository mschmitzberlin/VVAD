...
var SpinningWheel = {
	...
	create: function () {
		var i, l, out, ul, div, targetLeft, targetTop;

		this.reset();	// Initialize object variables
		
		// get the position of the target element
		
		//console.log("height" + targetHeight.offsetTop);
		console.log("height2" + $('#' + targetElem).offset().top);
		targetTop = $('#' + targetElem).offset().top;
		targetLeft = $('#' + targetElem).offset().left;
		console.log("height3 "  + window.innerHeight + " h4 " +window.pageYOffset);

		// Create the Spinning Wheel main wrapper
		div = document.createElement('div');
		div.id = 'sw-wrapper';
		div.style.top = window.innerHeight + window.pageYOffset + 'px';		// Place the SW down the actual viewing screen
		//div.style.top = targetHeight + 'px';		// Place the SW down the actual viewing screen
		//div.style.top = targetTop + 300  + 'px' ;		// Place the SW down the actual viewing screen
		//div.style.left = '500px' ;		// Place the SW down the actual viewing screen
	...
	open: function (elem) {
		...
		//document.getElementById(elem).innerHTML = 'cancelled!';
		targetElem = elem;
		//document.getElementById(elem).addEventListener("onchange", checkDate, false);
